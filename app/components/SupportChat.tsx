...
export default function SupportChat() {
  ...
  function answerWasNotHelpful() {
    ...
    setAwaitingFeedback(false);
    if (nextAttempt >= 3) {
      setMessages([...messages, { role: 'user', content: 'No, that still did not answer my question.' }, { role: 'assistant', content: 'I am sorry. We seem to be repeating ourselves without resolving your question. I can send this conversation to human support for review.' }]);
