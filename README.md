...
The basic layout, when the app is open, shows the desired video taking up most of the viewing area. A large blue button, labeled MENU shall appear off screen, to the top right of the monitor. This button, when clicked, will open up a drop-down list of all available features of the app. These shall be collapsed in a normal state until the user clicks on a particular function. At this time, the feature button will expand with a display of all controls for that feature. The user can click on the desired control and act upon it. When the user has finished, they can collapse the feature to make the interface as uncluttered as possible.
